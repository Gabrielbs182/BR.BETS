...
<div class="row">
    ...
    <div class="col-sm-8" id="div3">
        ...
        <!-- div do video -->
        <center>
            <iframe src="https://player.twitch.tv/?channel=sector_esports" height="400" width="640" frameborder="0" scrolling="no" allowfullscreen="false">
            </iframe>
        </center>
        <input type="hidden" id="idJogo" value="1">
...
<div class="row">
    ...
    <div class="col-sm-6" id="div2">
        ...
        <center>
            <button type="button" class="btn btn-primary btn-lg btn-block" id="botao" disabled>Partiadas Finalizadas</button>
        </center>
